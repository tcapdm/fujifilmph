...
$(iframes).each(function(i, item){
	...
	$(item).attr('width', winWidth + 'px').attr( 'height', sliderHeight);
	$(item).css({ 'width': winWidth + 'px', 'height': sliderHeight});
});

$(".home-slider .slick-track").on("DOMSubtreeModified",function(){
